...
function ActualizarCantidad() { 
    ...
    if (parseInt(document.getElementById("Mod_Ingreso").value) <= 0) {
        ...
        var ObjetoTabla = {
            ...
            Ingreso: document.getElementById("Mod_Ingreso").value,
            CantidadAnterior:CantidadAnterior,
            CantidadFinal:document.getElementById("Mod_CantidadTotal").value
        } 
        console.table(ObjetoTabla);
        $.post("/RecolectarBasico", // url
            {
                ObjetoTabla
            }, // data to be submit
        ...
        $('#FormularioRecolectar')[0].reset();
        $('#ModalRecolectar').modal('toggle');
        GETPRODUCTS();
    }
}
...
function Calcular() {
    console.log("Evento") 
    let Total = parseInt(document.getElementById("Mod_Cantidad").value) + parseInt(document.getElementById("Mod_Ingreso").value);
    console.log(Total) 
    document.getElementById("Mod_CantidadTotal").value = Total;
}

function Historial() {
    window.location.href='/ReporteRecolectarBasico'
}