            ...
            for (var i = 0; i < Herramientas.length; i++) {
                ...
                for (var x = 0; x < Arreglo.length; x++) {
                    ...
                    switch(x){
                        ...
                        break;
                        case 1: newCell.innerHTML = '<input required type="text" id="Clave'+i+'" class="form-control" placeholder="#####" value='+Arreglo[x]+'></input>';
                        break;
                        case 2: newCell.innerHTML = '<input required type="text" id="Producto'+i+'" class="form-control" placeholder="Herramienta..." value='+Arreglo[x]+'></input>';
                        break;
                        case 3: newCell.innerHTML = '<input required type="text" id="Ubicacion'+i+'" class="form-control" placeholder="E5C9..." value='+Arreglo[x]+'></input>';
                        break;
                    }
