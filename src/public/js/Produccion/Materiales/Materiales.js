    ...
    $.ajax({
        ...
        success: function (Lineas) {
            ...
            for (var i = 0; i < Lineas.length; i++) {
                ...
                Arreglo = [id, Inicio, OT, Maquina, CantOt, Recibido, Colada, Entrega, Recibe, Comentarios];
                ...
                for (var x = 0; x < Arreglo.length+1; x++) {
                    ...
                    if (x == 0) {
                        ...
                        newCell.innerHTML = '<input required type="text" id="Colada' + i + '" class="form-control" value="' + Arreglo[x] + '" ></input>';
                    } else if (x == 7) {
                        newCell.innerHTML = '<input required type="text" id="Entrega' + i + '" class="form-control" value="' + Arreglo[x] + '" ></input>';
                    } else if (x == 8) {
                        newCell.innerHTML = '<input required type="text" id="Recibe' + i + '" class="form-control" value="' + Arreglo[x] + '" ></input>';
                    } else if (x == 9) {
...
function ActualizarMaterial(variable) {
    ...
    let CantidadOT = tabla.rows[(variable+1)].cells[4].childNodes[0].nodeValue;
    ...
    let Entrega = document.getElementById("Entrega"+variable).value;
